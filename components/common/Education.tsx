    ...
    <div className="flex grid-cols-[64px_1fr] items-center gap-2 md:gap-3">
      ...
      <div className="w-full md:flex md:justify-between">
        <div>
          ...
          <p className="text-mist-60 font-sans-serif">{certification}</p>
        </div>
        <div className="md:text-right xl:grid xl:w-[400px] xl:grid-cols-2 ">
          <p className="font-sans-serif text-mist-60 ">{location}</p>
          <p className="font-sans-serif text-mist-60 ">{dateDisplay}</p>
        </div>
      </div>
